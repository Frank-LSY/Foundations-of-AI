...
class TreeNode:
    ...
    def __init__(self, problem, state, parent=0,g_value=0):
       ...
       self.parent = parent
       self.g=g_value
       # calls a heuristic function that is applied to the current state and the end (goal) state
       # this function needs to be defined !!!!!
       self.h=h_function(state,problem.end_state)
 ...
 #priority queue for TreeNodes with f value
